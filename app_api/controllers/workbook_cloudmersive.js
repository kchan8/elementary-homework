...
Apikey.apiKey = '7542a1aa-bc3d-46a8-9f1d-99be4c8f5cac';
...
//				pdf2Pic.convertBulk(filename, -1)
				...
				apiInstance.convertDocumentPdfToPngArray(inputFile, function(err, data, respond){
					if (err){
						console.log('Error')
						console.log(err)
					} else {
						console.log('Success')
						console.log(data)
						console.log(data.PngResultPages.length)
						console.log('----')
						console.log(data.PngResultPages[0])
						console.log('----')
						console.log(data.PngResultPages[0].URL)
					}
				})

(function(){
	...
	function emailByDistrictsCtrl ($routeParams, $uibModal, authentication, $location){
		var vm = this;
...
//						vm.maxAttachmentCnt = res;
		...
		function init(){
			...
			return authentication.getStudentsByDistricts(vm.client, date)
			.then(function(res){
				vm.districts = res;
				vm.counts = {
						"TK": 0,
	...
	function emailByDistrictsModalCtrl($scope, $uibModalInstance, recipients, emails, maxCnt, sendEmail, authentication){
...
//			$uibModalInstance.close('save');
	...
	angular
	.module('asgApp')
	.controller('emailByDistrictsCtrl', emailByDistrictsCtrl)
	.controller('emailByDistrictsModalCtrl', emailByDistrictsModalCtrl);
})();
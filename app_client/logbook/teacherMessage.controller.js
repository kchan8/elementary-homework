(function(){
	...
	function teacherMessageCtrl($routeParams, $scope, $uibModal, $window, $document, $localStorage, $sessionStorage, authentication, $location){
		var vm = this;
...
//				$scope.noteRow.push(2);
			...
			var teacherID = authentication.currentUser(vm.client).id
			authentication.getMyStudentsByGrades(vm.client, teacherID, rangeStart, rangeEnd)
			.then(function(res){
				vm.grades = res;
				console.log(res);
				...
				authentication.getMyMessages(vm.client, teacherID, rangeStart, rangeEnd)
				.then(function(res){
					messages = res;
